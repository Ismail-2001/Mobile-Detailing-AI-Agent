...
const QueryKnowledgeSchema = z.object({
    topic: z.enum(['pricing', 'policies', 'all', 'service_durations'])
});
...
export const MAYA_TOOLS = [
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Get internal business info on pricing, durations, or policies.',
            parameters: {
                type: 'object',
                properties: {
                    topic: { type: 'string', enum: ['pricing', 'policies', 'all', 'service_durations'] }
                },
                required: ['topic']
            }
        }
