            ...
            <div className={styles.kpiGrid}>
                <div className={styles.kpiCard}>
                    ...
                    <div className={styles.kpiData}>
                        <span>Maya Projected ROI</span>
                        <h3>$12,450</h3>
                        <p className={styles.subtext}>+12% tracking</p>
                    </div>
                </div>
                <div className={styles.kpiCard}>
                    ...
                    <div className={styles.kpiData}>
                        ...
                        <h3>64.2%</h3>
                        <p className={styles.subtext}>Maya Active Syncing</p>
                    </div>
                </div>
                <div className={styles.kpiCard}>
                    ...
                    <div className={styles.kpiData}>
                        ...
                        <p className={styles.subtext}>Verified Tool Calls</p>
                    </div>
                </div>
                <div className={styles.kpiCard}>
                    ...
                    <div className={styles.kpiData}>
                        ...
                        <h3>99.1%</h3>
                        <p className={styles.subtext}>Tool Validation Passed</p>
                    </div>
                </div>
            </div>
